...
def iw3p_parameter1_run():
    ...
    for itube_t in {8, 12}:
        for i, num in enumerate(shearkey_nums):
            ...
            itube = Itube(length=itube_length, shearkey_nums=num, shearkey_w=itube_shearkey_w, shearkey_h=itube_shearkey_h, thickness=itube_t)
            ...
            job_name = f"{num}w3p-parameter5-{itube_t}"
